...
function setTop() {
	...
	for (let i = 0; i < 6; i++) {
		...
		img_logo.src = 'https://raw.githubusercontent.com/macan88/CryptoLogos/main/dist/' + dexList[dex].chain_enum.toLowerCase() + '/' + address + '.png'
		img_logo.width = '20'
		img_logo.height = '20'
...
function setFavorites() {
	...
	Object.keys(favorites).forEach((favId) => {
		...
		div.id = favId
		let img_logo = document.createElement('img')
		img_logo.src = 'https://raw.githubusercontent.com/macan88/CryptoLogos/main/dist/' + fav.chain.toLowerCase() + '/' + fav.address + '.png'
		img_logo.width = '20'
		img_logo.height = '20'
    ...
    div.appendChild(div_symbol)*/
		...
		img_logo.src = 'https://raw.githubusercontent.com/macan88/CryptoLogos/main/dist/' + fav.chain.toLowerCase() + '/' + fav.base + '.png'
		img_logo.width = '20'
		img_logo.height = '20'
		img_logo.classList.add('favorite-logo')
...
function setToken(addr) {
	...
	tokenLogo.src = 'https://raw.githubusercontent.com/macan88/CryptoLogos/main/dist/' + dexList[dex].chain_enum.toLowerCase() + '/' + addr + '.png'
