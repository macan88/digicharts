...
/* Backend API url */
/* https://api2.digidex.finance or empty for localhost */
const DOMAIN_NAME = 'info.digidex.finance'
const SERVER_URL = window.location.href.includes(DOMAIN_NAME.toLowerCase()) ? 'https://api2.digidex.finance' : ''
